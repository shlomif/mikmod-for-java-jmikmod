...
/*#ifndef unix
	MyGlob(&argc, &argv, 0);
#endif*/
        MLoader = new MikMod.MLoader.clMLoader(this);

	MUniTrk = new clMUniTrk(this);
	mmIO = new MikMod.MMIO.MMIO(this);
	...
	M15_Loader cl_load_m15 = new MikMod.Loaders.M15_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_m15);
	MOD_Loader cl_load_mod = new MikMod.Loaders.MOD_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_mod);
	MTM_Loader cl_load_mtm = new MikMod.Loaders.MTM_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_mtm);
	S3M_Loader cl_load_s3m = new MikMod.Loaders.S3M_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_s3m);
	STM_Loader cl_load_stm = new MikMod.Loaders.STM_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_stm);
	ULT_Loader cl_load_ult = new MikMod.Loaders.ULT_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_ult);
	UNI_Loader cl_load_uni = new MikMod.Loaders.UNI_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_uni);
	S69_Loader cl_load_669 = new MikMod.Loaders.S69_Loader(this);
	MLoader.ML_RegisterLoader(cl_load_669);
	XM_Loader  cl_load_xm = new MikMod.Loaders.XM_Loader(this);
